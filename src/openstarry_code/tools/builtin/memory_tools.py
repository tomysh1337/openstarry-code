...
Usage (single store — backward compatible):
    from openstarry_code.agents.scope import default_state_dir, default_workspace_dir
    from openstarry_code.memory import LongTermMemoryStore, MemoryRetriever
...
from openstarry_code.memory.redaction import redact_memory_text
from openstarry_code.memory.source_paths import is_memory_source_path, is_searchable_source_path
...
def _is_memory_source_path(path: str) -> bool:
    """Return True for OpenStarry Code memory source files."""
    ...
    *,
    ...
    def _resolve() -> ResolvedAgent:
        ...
        if memory_source == "workspace":
            ...
            from openstarry_code.agents.scope import (
        ...
        from openstarry_code.memory.manager import _native_io_path
