...
from openstarry_code.safety.permission_matrix import CHANNEL_WEBUI, Principal, is_tool_allowed
...
from openstarry_code.tools.policy.types import DispatchInput, PolicyDecision
from openstarry_code.tools.policy_helpers import private_memory_read_tool_denied
from openstarry_code.tools.types import CallerKind, ToolContext
from openstarry_code.tools.visibility import guest_safe_tool_allowed
...
class ProfilePolicy:
    ...
    def evaluate(self, d: DispatchInput) -> PolicyDecision:
        # Imported lazily — openstarry_code.tools.registry imports
        # openstarry_code.tools.policy at module-load time, so a top-level
        # import here would create a circular dependency.
        from openstarry_code.tools.registry import profile_allows_tool, resolve_profile
