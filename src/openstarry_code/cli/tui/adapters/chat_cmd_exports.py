"""Lazy private export resolver for ``openstarry_code.cli.chat_cmd``.
...
from openstarry_code.cli.chat.launch import ChatCommandRequest as _ChatCommandRequest

_CHAT_COMPAT_MODULE = "openstarry_code.cli.tui.adapters.chat_compat"
_RUNTIME_BRIDGE_MODULE = "openstarry_code.cli.tui.adapters.runtime_bridge"
_LAUNCH_BRIDGE_MODULE = "openstarry_code.cli.tui.adapters.launch_bridge"
...
def resolve_legacy_chat_cmd_export(name: str) -> Any:
    ...
    raise AttributeError(f"module 'openstarry_code.cli.chat_cmd' has no attribute {name!r}")
