"""Typed default launcher resolver for ``openstarry-code chat``."""
...
from openstarry_code.cli.chat.frontend import ChatCommandLauncher
...
def _chat_cmd_exports() -> Any:
    return importlib.import_module("openstarry_code.cli.tui.adapters.chat_cmd_exports")


def default_chat_launcher() -> ChatCommandLauncher:
    module = importlib.import_module("openstarry_code.cli.tui.adapters.launch_bridge")
