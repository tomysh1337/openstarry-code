...
from openstarry_code.cli.chat.session_state import messages_to_markdown
from openstarry_code.cli.gateway_client import session_history_all
...
async def _with_client(action):
    ...
    try:
        await client.connect(
            normalize_gateway_url(os.environ.get("OPENSTARRY_CODE_GATEWAY_URL", "ws://localhost:18791/ws"))
        )
