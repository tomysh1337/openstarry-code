...
from openstarry_code.cli.ui import ACCENT_HEADER, ACCENT_MARKUP, console

app = typer.Typer(help="Manage OpenStarry Code configuration.")
...
def config_get(
    ...
    cfg = GatewayConfig.load(config_path or os.environ.get("OPENSTARRY_CODE_GATEWAY_CONFIG_PATH"))
...
def config_set(
    ...
    env_key = "OPENSTARRY_CODE_GATEWAY_" + key.upper().replace(".", "__")
