"""Gateway-backed implementation for the inbound OpenStarry Code MCP bridge."""
...
from openstarry_code.gateway_client import normalize_gateway_url
...
class OpenSquillaMCPBridge:
    ...
    def __init__(
        ...
        *,
        ...
        raw_url = (
            gateway_url
            or os.environ.get("OPENSTARRY_CODE_GATEWAY_URL")
