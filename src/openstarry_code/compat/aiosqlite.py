...
_timeout_raw = os.getenv("OPENSTARRY_CODE_AIOSQLITE_CONNECT_TIMEOUT_SEC", "1.0")
try:
    _AIOSQLITE_TIMEOUT_SECONDS = float(_timeout_raw)
except ValueError:
    _AIOSQLITE_TIMEOUT_SECONDS = 1.0
_FORCE_SQLITE3_FALLBACK = os.getenv("OPENSTARRY_CODE_FORCE_SQLITE3_BACKEND", "").lower() in {
    "1",
    "true",
    "yes",
    "on",
