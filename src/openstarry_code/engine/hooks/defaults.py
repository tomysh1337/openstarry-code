...
from openstarry_code.engine.hooks.types import (
    CompactionHook,
    CompactionState,
    ToolHook,
    ToolHookCall,
...
from openstarry_code.observability.trace import TraceEvent, write_trace_event

log = structlog.get_logger("openstarry_code.engine.hooks")
...
class DefaultMemoryFlushHook:
    ...
    The actual flush task lives in :mod:`openstarry_code.engine.agent` and depends
