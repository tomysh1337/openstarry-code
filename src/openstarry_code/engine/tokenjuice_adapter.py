"""Tokenjuice bridge for OpenStarry Code tool-result projection."""
...
from openstarry_code.plugins.tokenjuice import reduce_tool_result as _reduce_tool_result_backend
