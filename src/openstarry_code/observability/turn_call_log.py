...
TURN_CALL_LOG_ENV = "OPENSTARRY_CODE_TURN_CALL_LOG"
TURN_CALL_LOG_DIR_ENV = "OPENSTARRY_CODE_TURN_CALL_LOG_DIR"
LOG_DIR_ENV = "OPENSTARRY_CODE_LOG_DIR"
...
def _default_log_dir() -> Path:
    ...
    ``OPENSTARRY_CODE_TURN_CALL_LOG_DIR`` is specific to this raw debug stream. When it
    is not set, reuse ``OPENSTARRY_CODE_LOG_DIR`` so all observability files remain
