...
Requirements:
    duckduckgo-search, declared by the OpenStarry Code project dependencies
"""
...
try:
    ...
    print("Sync or reinstall the OpenStarry Code project dependencies.", file=sys.stderr)
    sys.exit(1)
