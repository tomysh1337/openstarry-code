---
name: reverse-skill
description: Master router for reverse engineering, authorized security research, CTF, binary, APK, JavaScript, firmware, mobile, malware, pwn, and API tasks. Use to select this package's specialized workflow and shared toolchain.
---
...
支持的能力：jadx、apktool、frida、frida-ps、frida-python、angr-python、z3-python、qiling-python、uncompyle6、idalib-mcp、jshookmcp、anything-analyzer、idapro、r2、rabin2、adb、agent-browser、x64dbg、ghidra-mcp、seclists、proxycat、burpsuite-mcp、nmap、pentestswarm、binwalk、yara、floss、pwntools
