...
$scriptRefs = @{
    ...
    'pyghidra' = @('reverse-engineering/SKILL.md', 'ida-reverse/SKILL.md')
    'vineflower' = @('reverse-engineering/languages-platforms.md')
    'cfr' = @('reverse-engineering/languages-platforms.md')
    'procyon' = @('reverse-engineering/languages-platforms.md')
    'javap' = @('reverse-engineering/languages-platforms.md')
    'jdeps' = @('reverse-engineering/languages-platforms.md')
    'jar' = @('reverse-engineering/languages-platforms.md')
    'r2ghidra' = @('radare2/SKILL.md')
    'r2ghidra-sleigh' = @('radare2/SKILL.md')
    'diec' = @('reverse-engineering/tools.md')
    'floss' = @('reverse-engineering/tools.md', 'malware-analysis/SKILL.md')
    'capa' = @('reverse-engineering/tools.md', 'malware-analysis/SKILL.md')
    'pe-bear' = @('reverse-engineering/tools.md')
    'x64dbg' = @('reverse-engineering/tools-dynamic.md', '../binary-re-dynamic-analysis/SKILL.md')
    'x32dbg' = @('reverse-engineering/tools-dynamic.md', '../binary-re-dynamic-analysis/SKILL.md')
    'objdump' = @('reverse-engineering/tools.md')
    'nm' = @('reverse-engineering/tools.md')
    'gnu-strings' = @('reverse-engineering/SKILL.md')
    'sigcheck' = @('reverse-engineering/tools.md')
    'sysinternals-strings' = @('reverse-engineering/tools.md')
    'capstone-python' = @('reverse-engineering/tools.md')
    'lief-python' = @('reverse-engineering/tools-advanced.md')
    'pefile-python' = @('reverse-engineering/tools.md')
    'r2pipe-python' = @('radare2/SKILL.md')
    'unicorn-python' = @('reverse-engineering/tools-dynamic.md')
    'yara-python' = @('malware-analysis/SKILL.md')
    'angr-python' = @('reverse-engineering/tools-advanced.md')
    'z3-python' = @('reverse-engineering/tools-advanced.md')
    'qiling-python' = @('reverse-engineering/tools-dynamic.md')
    'frida-python' = @('apk-reverse/SKILL.md', 'reverse-engineering/tools-dynamic.md')
    'uncompyle6' = @('reverse-engineering/languages-platforms.md')
    'proxycat' = @('pentest-tools/SKILL.md')
    'nmap' = @('pentest-tools/SKILL.md')
    'wireshark' = @('pentest-tools/SKILL.md', 'routing.md', 'field-journal/seed-011_pcap-protocol-reverse.md')
    'tshark' = @('pentest-tools/SKILL.md', 'routing.md', 'field-journal/seed-011_pcap-protocol-reverse.md')
    'dumpcap' = @('pentest-tools/SKILL.md', 'routing.md', 'field-journal/seed-011_pcap-protocol-reverse.md')
    'capinfos' = @('pentest-tools/SKILL.md', 'routing.md', 'field-journal/seed-011_pcap-protocol-reverse.md')
    'editcap' = @('pentest-tools/SKILL.md', 'routing.md', 'field-journal/seed-011_pcap-protocol-reverse.md')
    'mergecap' = @('pentest-tools/SKILL.md', 'routing.md', 'field-journal/seed-011_pcap-protocol-reverse.md')
    'text2pcap' = @('pentest-tools/SKILL.md', 'routing.md', 'field-journal/seed-011_pcap-protocol-reverse.md')
...
$capabilityNames = @(Get-ReverseBootstrapCatalog | ForEach-Object { $_.name } | Sort-Object -Unique)
$capabilityRows = @()
