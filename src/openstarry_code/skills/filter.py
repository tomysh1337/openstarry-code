"""Backwards-compat shim for openstarry_code.skills.filter.
...
The relevance-filtering logic itself lives in openstarry_code.skills.retrieval.
...
def build_skills_prompt(
    ...
    *,
    ...
    routed through :func:`openstarry_code.safety.injection_guard.xml_escape` before
...
class SkillFilter(HybridRetriever):
    """Deprecated. Use ``openstarry_code.skills.retrieval.HybridRetriever``."""

    def __init__(self, *args, **kwargs) -> None:
        warnings.warn(
            "openstarry_code.skills.filter.SkillFilter is deprecated; "
            "use openstarry_code.skills.retrieval.HybridRetriever",
            DeprecationWarning,
            stacklevel=2,
        )
