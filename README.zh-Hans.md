...
| 产物 | 用途 | 完整性 |
| --- | --- | --- |
| [`OpenStarry-Code-0.6.0-win-x64.exe`](https://github.com/tomysh1337/openstarry-code/releases/download/v0.6.0/OpenStarry-Code-0.6.0-win-x64.exe) | NSIS Windows 交互式安装包 | 记录于 `SHA256SUMS` |
| [`OpenStarry-Code-0.6.0-win-x64.msi`](https://github.com/tomysh1337/openstarry-code/releases/download/v0.6.0/OpenStarry-Code-0.6.0-win-x64.msi) | WiX MSI Windows 安装包 | 记录于 `SHA256SUMS` |
| [`openstarry_code-0.6.0-py3-none-any.whl`](https://github.com/tomysh1337/openstarry-code/releases/download/v0.6.0/openstarry_code-0.6.0-py3-none-any.whl) | 包含已编译 Web UI 的 Python 运行时 | 记录于 `SHA256SUMS` |
| [`openstarry_code-0.6.0.tar.gz`](https://github.com/tomysh1337/openstarry-code/releases/download/v0.6.0/openstarry_code-0.6.0.tar.gz) | 可复现的源码发行包 | 记录于 `SHA256SUMS` |
...
OpenStarry Code v0.6.0 已提供独立 Windows 安装包。需要核对上游 0.5.3 行为时，
对应的固定版本 GitHub 产物为：
